...
const permanentDeleteTrades = require("../../controllers/trade/permanentDeleteTrades");
...
const robinhoodCsvUpload = require("../../controllers/trade/csv/robinhoodCsvUpload");
...
const assignedTags = require("../../controllers/trade/assignedTags");
const updateTrade = require("../../controllers/trade/updateTrade");
const thinkorswimCsvUpload = require("../../controllers/trade/csv/thinkorswimCsvUpload");
...
router.post("/robinhood/csv/upload", robinhoodCsvUpload);
//thinkorswim csv upload
router.post("/thinkorSwim/csv/upload", thinkorswimCsvUpload);
router.get("/exist/:symbol", existTrade);
router.delete("/permanent-delete", permanentDeleteTrades);
...
router.get("/:tradeId/assigned-tags", assignedTags);
