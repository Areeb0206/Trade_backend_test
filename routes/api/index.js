...
const updateQuesTradeAccessToken = require("../../controllers/broker/agenda/updateQuesTradeAccessToken");
...
router.use("/watchlist", jwtValidation, require("./Watchlist.route"));
router.post("/agenda", agendaCallService);
router.post("/agenda/snap-commission", agendaCallServiceForSnapService);
router.post("/agenda/questrade-access-token", updateQuesTradeAccessToken);
