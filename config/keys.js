...
//list of instruments
// https://www.stocklyzer.com/derivatives
...
module.exports = {
  ...
  aws: {
    ...
    sesRegion: process.env.SES_AWS_REGION,
    sesSenderAddress: process.env.AWS_SES_SENDER_ADDRESS,
    sesAccessKey: process.env.SES_ACCESSKEY,
  ...
  etrade: {
    sandboxUrl: process.env.ETRADE_SANDBOX_URL,
    productionUrl: process.env.ETRADE_PRODUCTION_URL,
    authorizedUrl: process.env.ETRADE_AUTHORIZATION_URL,
    baseUrl:
      process.env.NODE_ENV === "test"
        ? process.env.ETRADE_SANDBOX_URL
        : process.env.ETRADE_PRODUCTION_URL,
  },
  polygon_option_chain: {
    apiKey: process.env.POLYGON_OPTION_CHAIN_API_KEY,
    snapShotUrl: process.env.POLYGON_OPTION_SNAPSHOT_URL,
  },
};
