...
@media only screen and (max-width: 600px) and (min-width: 320px) {
  ...
  .m-height30 {font-size:20px!important;line-height:30px!important;height:30px!important;}
...
<style type="text/css" class="export-delete"> 
  ...
  .composer--mobile .m-height30 {font-size:20px!important;line-height:30px!important;height:30px!important;}
...
<table data-outer-table border="0" align="center" cellpadding="0" cellspacing="0" class="outer-table row" role="presentation" width="580" style="width:580px;max-width:580px;" data-module="black-logo">
  ...
  <tr>
    <td height="30" style="font-size:20px;line-height:30px;" data-height="Spacing bottom"> </td>
  </tr>
  <!-- black-logo -->
</table>
...
<table data-outer-table border="0" align="center" cellpadding="0" cellspacing="0" class="outer-table row" role="presentation" width="580" style="width:580px;max-width:580px;" data-module="black-intro-2">
  <!-- black-intro-2 -->
  <tr>
    <td height="30" style="font-size:20px;line-height:30px;" data-height="Spacing top"> </td>
  </tr>
  ...
  <tr data-element="black-intro-2-paragraph" data-label="Intro Paragraph">
    <td data-text-style="Intro Paragraph" align="center" style="font-family:'Roboto',Arial,Helvetica,sans-serif;font-size:18px;line-height:32px;font-weight:400;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;">
        <singleline>
          <div mc:edit data-text-edit>
            A new ticket has been created by a user. Please review the details below.
          </div>
        </singleline>
    </td>
  </tr>
...
<table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="580" style="width:580px;max-width:580px;" data-module="black-footer">
  <!-- black-footer -->
  <tr>
    <td height="30" style="font-size:20px;line-height:30px;" data-height="Footer spacing top"> </td>
  </tr>
  ...
  <tr data-element="black-footer-paragraphs" data-label="Paragraphs">
    <td align="center">
      <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="480" style="width:480px;max-width:480px;">
        <tr>
          <td class="center-text" data-text-style="Paragraphs" align="left" style="font-family:'Roboto',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#999999;text-decoration:none;letter-spacing:0px;">
            <multiline>
              <div mc:edit data-text-edit style="font-size:20px;display:grid;grid-cols-1;gap:15px">
<div style="line-height:40px;" >
                <span style="font-size:20px;color:white">User:</span> <span style="font-size:20px;color:white">${userName} </span> <br>
</div>
<div style="line-height:40px;" >
              <span style="font-size:20px;color:white">Email:</span> <span style="font-size:20px;color:white">${userEmail} </span> <br>
</div>
<div style="line-height:40px;" >
                <span style="font-size:20px;color:white"> Subject:</span> <span style="font-size:20px;color:white">${ticketSubject}</span> <br>
</div>
<div style="line-height:40px;" >

                <span style="font-size:20px;color:white"> Type:</span> <span style="font-size:20px;color:white">${ticketType}</span> <br>
            </div>
<div style="line-height:40px;" >

                <span style="font-size:20px;color:white">Description:</span><br> <span style="font-size:20px;color:white">${ticketDescription}</span>  <br>
         </div>
                </div>
            </multiline>
          </td>
...
<table data-outer-table border="0" align="left" cellpadding="0" cellspacing="0" class="outer-table row" role="presentation" width="580" style="width:580px;max-width:580px;" data-module="black-splitter">
  <!-- black-splitter -->
  <tr>
    <td height="30" style="font-size:20px;line-height:30px;" data-height="Spacing top"> </td>
  </tr>
