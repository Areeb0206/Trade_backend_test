...
const invitationTemplate = ({ url, name }) => {
...
<table data-outer-table border="0" align="center" cellpadding="0" cellspacing="0" class="outer-table row" role="presentation" width="580" style="width:580px;max-width:580px;" data-module="black-intro-2">
  ...
  <tr data-element="black-intro-2-paragraph" data-label="Intro Paragraph">
    <td data-text-style="Intro Paragraph" align="center" style="font-family:'Roboto',Arial,Helvetica,sans-serif;font-size:18px;line-height:32px;font-weight:400;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;">
        <singleline>
          <div mc:edit data-text-edit>
            We have introduced TradeLizer, a new platform aimed to simplify your trading experience and provide you with additional tools to help you improve your tactics.
          </div>
        </singleline>
    </td>
  </tr>
  ...
  <tr data-element="black-intro-2-button" data-label="Intro Button">
    <td align="center">
      ...
      <table border="0" cellspacing="0" cellpadding="0" role="presentation" align="center">
        <tr>
          <td align="center" data-border-radius-default="0,6,36" data-border-radius-custom="Intro Button" data-bgcolor="Intro Button" bgcolor="#1A96F4" style="border-radius: 6px;">
      <!--[if (gte mso 9)|(IE)]>
        <table border="0" cellpadding="0" cellspacing="0" align="center">
          <tr>
            ...
            <![endif]-->
              <singleline>
                <a href=${url} mc:edit data-button data-text-style="Intro Button" style="font-family:'Roboto Slab',Arial,Helvetica,sans-serif;font-size:18px;line-height:28px;font-weight:700;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;padding: 16px 38px 16px 38px;display: inline-block;"><span>VERIFY ACCOUNT</span></a>
              </singleline>
            <!--[if (gte mso 9)|(IE)]>
            </td>
            <td align="center" width="38"></td>
  ...
  <tr>
   ...
   <footer class="footer">
            <div class="social-links">
                ...
                <a href="https://x.com/tradelizerapp" class="social-link"><img src="https://img.freepik.com/free-vector/new-2023-twitter-logo-x-icon-design_1017-45418.jpg?size=338&ext=jpg&ga=GA1.1.2008272138.1724630400&semt=ais_hybrid" alt="Twitter" class="social-icon"></a>
            </div>
